# Com essa possibilidade, conseguimos criar um dicionário de jogos, onde teremos dentro dessa estrutura, três dicionários que representam informações de cada um dos jogos que formos escolher.
